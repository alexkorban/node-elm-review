...
const flags = [
  {
    ...
    description: [
      `Include ${orange(
        'suppressed'
      )} errors in the error report for all rules.`
    ]
  },
  {
    ...
    description: [
      `Include ${orange(
        'suppressed'
      )} errors in the error report for the listed rules.`,
  ...
  },
  {
    ...
    sections: ['suppress'],
    description: [
      `Checks whether there are uncommitted changes. Running ${chalk.greenBright('elm-review')} may`,
      `cause suppression files to be updated, which people can forget to commit`,
